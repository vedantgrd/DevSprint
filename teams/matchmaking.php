    ...
    <div class="nav-container">
        ...
        <ul class="nav-menu" id="nav-menu">
            ...
            <?php if(isset($_SESSION['user_id'])): ?>
                ...
                <li><a href="../teams/matchmaking.php" class="active">Find Teammates</a></li>
...
<div class="page-wrapper">
    <div class="content-section">
        ...
        <div class="alert alert-info" style="max-width:700px;margin:0 auto 2rem;">
            ...
            &nbsp;<a href="../teams/matchmaking.php" style="color:var(--plasma-cyan);font-weight:700;">Clear ×</a>
        </div>
        <?php endif; ?>
            ...
            <?php if(!empty($scored_users)): ?>
                ...
                <div class="user-card reveal">
                    ...
                    <div class="invite-section">
                        <form action="../actions/team_action.php" method="POST">
