...
if ($team_id <= 0) { header("Location: ../teams/teams.php"); exit(); }
    ...
    <div class="nav-container">
        ...
        <ul class="nav-menu" id="nav-menu">
            ...
            <?php if(isset($_SESSION['user_id'])): ?>
                <li><a href="../teams/teams.php" class="active">Teams</a></li>
...
<div class="page-wrapper">
    <div class="td-layout">
        ...
        <div class="team-banner reveal">
            <a href="../teams/teams.php" class="back-link-inline">← Back to Teams</a>
            ...
            <div class="join-request-banner">
                ...
                <form action="../actions/team_action.php" method="POST" style="display:inline;">
            ...
            <div class="members-grid">
                ...
                <div class="member-card">
                    ...
                    <div class="member-actions">
                        <form action="../actions/team_action.php" method="POST" style="margin:0;">
                            <input type="hidden" name="csrf_token" value="<?= function_exists('generate_csrf_token') ? generate_csrf_token() : '' ?>">
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function loadMessages() {
                fetch(`../includes/api_chat.php?team_id=${teamId}`)
                .then(r => r.json())
                .then(msgs => {
                    chatBox.innerHTML = '';
                    if (msgs.length === 0) {
            ...
            chatForm.addEventListener('submit', (e) => {
                ...
                fetch('../includes/api_chat.php', { method:'POST', body:fd })
                .then(r => r.json())
        ...
        <div class="settings-card reveal d3">
            ...
            <div class="settings-row">
                <form action="../actions/team_action.php" method="POST" style="margin:0;display:flex;gap:0.75rem;flex:1;flex-wrap:wrap;">
                    <input type="hidden" name="csrf_token" value="<?= function_exists('generate_csrf_token') ? generate_csrf_token() : '' ?>">
            ...
            <form action="../actions/team_action.php" method="POST" onsubmit="return confirm('⚠️ Delete this team entirely? All members and applications will be removed. This cannot be undone.');">
                <input type="hidden" name="csrf_token" value="<?= function_exists('generate_csrf_token') ? generate_csrf_token() : '' ?>">
