...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Orbitron:wght@400;600;700;900&family=Syne:wght@400;500;600;700&family=JetBrains+Mono:wght@300;400;500&display=swap"
        rel="stylesheet">
    ...
    <style>
        ...
        *::after {
        ...
        .nav-logo svg {
            width: 40px;
            height: 40px;
            filter: drop-shadow(0 0 8px var(--plasma-cyan));
        }
        ...
        .hero-orbit-2::before {
            ...
            filter: drop-shadow(0 0 6px var(--pulsar-violet));
        }
        ...
        .hero-title .line-2 {
            ...
            background-clip: text;
            background-size: 200%;
            animation: gradientFlow 4s ease infinite, fadeUp 1s ease 0.4s both;
        }
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 0 50px rgba(0, 229, 255, 0.4), 0 0 100px rgba(124, 77, 255, 0.25);
        }
        ...
        .event-img-wrap {
            ...
            overflow: hidden;
            position: relative;
            box-shadow: 0 0 80px rgba(124, 77, 255, 0.3), 0 40px 80px rgba(0, 0, 0, 0.5);
        }
        ...
        .event-img-overlay {
            position: absolute;
            inset: 0;
            background: linear-gradient(to top, rgba(0, 0, 10, 0.6), transparent);
        }
        ...
        .footer-brand-col .nav-brand-text {
            font-size: 1.5rem;
            display: block;
            margin-bottom: 1rem;
        }
...
<body>
            ...
            <a href="../home/index.php" class="nav-brand">
                <div class="nav-logo">
                    <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ellipse cx="20" cy="20" rx="18" ry="7" fill="none" stroke="#7c4dff" stroke-width="1"
                            transform="rotate(30 20 20)" />
                        <ellipse cx="20" cy="20" rx="18" ry="7" fill="none" stroke="#00e5ff" stroke-width="1"
                            opacity="0.4" transform="rotate(-30 20 20)" />
    ...
    <section class="hero">
        ...
        <p class="hero-sub">Your launchpad to India's most exciting hackathons. Navigate the cosmos of code, connect
            with engineers across galaxies, and launch your ideas into orbit.</p>
        <div class="hero-cta">
            <a href="../hackathons/hackathons.php" class="btn btn-primary">
                <span>Explore Events</span>
                <span class="btn-arrow">↗</span>
            </a>
            <a href="../about/about.php" class="btn btn-ghost">
    ...
    <section class="content-section">
        <div class="features-layout">
            <div class="features-header reveal-left">
                ...
                <p class="section-desc">Everything you need to discover, prepare, and dominate hackathons — engineered
                    for the serious builder.</p>
            </div>
            <div class="feature-list">
                <div class="feature-item reveal d1">
                    ...
                    <div class="feature-text">
                        ...
                        <p>We scan the cosmos daily to surface the best hackathons matched to your skills, location, and
                            tech stack.</p>
                    </div>
                </div>
                <div class="feature-item reveal d2">
                    ...
                    <div class="feature-text">
                        ...
                        <p>Get intelligent project concepts with resource guides, tech stack suggestions, and
                ...
                <div class="feature-item reveal d3">
                    ...
                    <div class="feature-text">
                        ...
                        <p>Full transparency on prizes, sponsors, judging criteria, and networking opportunities before
                            you commit.</p>
                    </div>
                </div>
        ...
        <div class="event-card-3d" id="event3d">
            <div class="event-card-inner" id="eventCardInner">
                ...
                <div>
                    ...
                    <p class="event-desc">India's premier 48-hour hackathon — a supernova of innovation, mentorship, and
                        networking. 500+ participants, 15 problem tracks, and live pitches to top VCs.</p>
                    <div class="event-meta-grid">
                        <div class="event-meta-item">
                            <div class="meta-key">Location</div>
                            <div class="meta-val">🗺️ Bangalore, India</div>
                        </div>
                        <div class="event-meta-item">
                            <div class="meta-key">Date</div>
                            <div class="meta-val">📅 Mar 15–17, 2026</div>
                        </div>
                        <div class="event-meta-item">
                            <div class="meta-key">Prize Pool</div>
                            <div class="meta-val">💰 ₹50,000</div>
                        </div>
                        <div class="event-meta-item">
    ...
    <section class="categories-section">
        <div class="categories-header">
            ...
            <a href="../hackathons/hackathons.php" class="btn btn-ghost reveal-right" style="white-space:nowrap">View All →</a>
        </div>
        <div class="cat-grid">
            <div class="cat-card reveal d1"><span class="cat-emoji">🤖</span>
                <div class="cat-name">AI / Machine Learning</div>
                <div class="cat-count">14 events</div>
            </div>
            <div class="cat-card reveal d2"><span class="cat-emoji">🔗</span>
                <div class="cat-name">Web3 / Blockchain</div>
                <div class="cat-count">9 events</div>
            </div>
            <div class="cat-card reveal d3"><span class="cat-emoji">🌐</span>
                <div class="cat-name">Web Development</div>
                <div class="cat-count">18 events</div>
            </div>
            <div class="cat-card reveal d4"><span class="cat-emoji">📱</span>
                <div class="cat-name">Mobile Apps</div>
                <div class="cat-count">11 events</div>
            </div>
            <div class="cat-card reveal d5"><span class="cat-emoji">🔒</span>
                <div class="cat-name">Cybersecurity</div>
                <div class="cat-count">6 events</div>
            </div>
            <div class="cat-card reveal d1"><span class="cat-emoji">☁️</span>
                <div class="cat-name">Cloud / DevOps</div>
                <div class="cat-count">8 events</div>
            </div>
            <div class="cat-card reveal d2"><span class="cat-emoji">🎮</span>
                <div class="cat-name">Game Development</div>
                <div class="cat-count">5 events</div>
            </div>
            <div class="cat-card reveal d3"><span class="cat-emoji">🏥</span>
                <div class="cat-name">HealthTech</div>
    ...
    <div class="content-section" style="padding-top:1rem;padding-bottom:4rem;">
        <div class="cta-band reveal"
            style="margin:0 2rem 4rem; display:flex; flex-direction:column; align-items:center; text-align:center;">
            <h2>Ready for launch?</h2>
            <p>Join 1,200+ developers already sprinting toward the future.</p>
            <a href="../login/login_view.php" class="btn btn-primary">
    ...
    <footer>
        <div class="footer-grid">
            <div class="footer-brand-col">
                <span class="nav-brand-text">DevSprint</span>
                <p>India's premier hackathon discovery platform. Navigate the universe of tech competitions and launch
                    your ideas into orbit.</p>
