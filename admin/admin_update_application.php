                    ...
                    <div style='max-width:600px; margin:0 auto; background-color:#00000a; border:1px solid #00e5ff33; border-radius:12px; overflow:hidden; font-family:Arial, sans-serif;'>
                        ...
                        <div style='padding:35px;'>
                            ...
                            <div style='text-align:center; margin-top:35px; margin-bottom:10px;'>
                                <a href='http://localhost/WP-class/profile/profile.php' style='background-color:#7c4dff; color:#ffffff; text-decoration:none; padding:14px 28px; border-radius:8px; font-weight:bold; font-family:monospace; display:inline-block;'>View Mission Log</a>
                            </div>
                        </div>
