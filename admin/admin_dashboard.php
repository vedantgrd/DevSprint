...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        /* ── Content Grid ── */
        /* Left col (form) is fixed-ish, right col takes remaining space */
        .dash-grid {
            display: grid;
...
<body>
    ...
    <div class="dash-layout">
        ...
        <!-- ── SIDEBAR ── -->
        <aside class="sidebar">
            <a href="../home/index.php" class="sidebar-brand">
                <svg width="26" height="26" viewBox="0 0 40 40" fill="none">
                    ...
                    <ellipse cx="20" cy="20" rx="18" ry="7" fill="none" stroke="#00e5ff" stroke-width="1" opacity="0.4"
                        transform="rotate(-30 20 20)" />
            ...
            <a href="../admin/admin_dashboard.php" class="sidebar-link active">
                <span class="link-icon">🏠</span> Dashboard
            </a>
            <a href="../home/index.php" class="sidebar-link" target="_blank">
            ...
            <a href="../admin/admin_messages.php" class="sidebar-link">
            ...
            <div class="sidebar-logout">
                <a href="../admin/admin_logout.php" class="sidebar-link"
                    style="color:#ef4444; border:1px solid rgba(239,68,68,0.15); border-radius:6px;">
        ...
        <main class="dash-main">
            ...
            <div class="dash-header">
                ...
                <div class="systems-status">
                    ...
                    <span
                        style="font-family:'JetBrains Mono',monospace; font-size:0.72rem; color:#00e676; white-space:nowrap;">Systems
                        Online</span>
                </div>
            </div>
            ...
            <?php elseif (isset($_SESSION['profile_error'])): ?>
                <div class="alert alert-error">⚠️ <?= htmlspecialchars($_SESSION['profile_error']) ?></div>
            ...
            <div class="dash-grid">
                ...
                <div id="add-section" class="d-card">
                    ...
                    <form action="../admin/admin_add_hackathon.php" method="POST">
                        <input type="hidden" name="csrf_token"
                            value="<?= function_exists('generate_csrf_token') ? generate_csrf_token() : '' ?>">
                        ...
                        <div class="form-group">
                            <label>Pin Location on Map <span style="color:#7b8eb0; font-weight:400;">(Optional for
                                    virtual)</span></label>
                            <div id="adminMap"
                                style="height:340px; border-radius:6px; border:1px solid rgba(79,195,247,0.15); z-index:10;">
                            </div>
                            <input type="hidden" name="latitude" id="latInput">
                            <input type="hidden" name="longitude" id="lngInput">
                            <small
                                style="color:#00e5ff; font-family:'JetBrains Mono',monospace; font-size:0.62rem; margin-top:5px; display:block;">Click
                                on the map to drop a coordinate pin.</small>
                        </div>
                        <div class="form-group">
                        ...
                        <div id="duration_display"
                            style="color:#00e676; font-family:'JetBrains Mono',monospace; font-size:0.72rem; margin-top:-6px; margin-bottom:12px; display:none;">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" rows="4" required
                                placeholder="Describe the hackathon..."></textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <table class="data-table">
                                ...
                                <tbody>
                                    <?php if ($applications && $applications->num_rows > 0):
                                        while ($a = $applications->fetch_assoc()): ?>
                                            <tr>
                                                <td>
                                                    ...
                                                    <small
                                                        style="font-family:'JetBrains Mono',monospace; font-size:0.65rem; color:#7b8eb0;">
                                                        <?= htmlspecialchars($a['team_name'] ? '🛸 ' . $a['team_name'] : '👤 Individual') ?>
                                                    </small>
                                                </td>
                                                ...
                                                <td
                                                    style="font-family:'JetBrains Mono',monospace; font-size:0.75rem; white-space:nowrap;">
                                                ...
                                                <td class="td-actions">
                                                    <?php if ($a['team_name']): ?>
                                                        <a href="admin_view_team.php?app_id=<?= $a['id'] ?>"
                                                            class="team-view-btn">View Team</a>
                                                    <?php else: ?>
                                                        <?php if ($st === 'Pending'): ?>
                                                            <div style="display:flex; flex-direction:column; gap:0.18rem;">
                                                                <form action="../admin/admin_update_application.php" method="POST"
                                                                    ...
                                                                    <button type="submit" class="action-accept-btn">✓ Accept</button>
                                                                </form>
                                                                <form action="../admin/admin_update_application.php" method="POST"
                                                                    style="margin:0;">
                                                                    <input type="hidden" name="csrf_token"
                                                                    ...
                                                                    <button type="submit" class="action-reject-btn">✕ Reject</button>
                                                                </form>
                                                            </div>
                                                        <?php else: ?>
                                                            <span
                                                                style="color:#7b8eb0; font-size:0.72rem; font-family:'JetBrains Mono',monospace;">✓
                                                                Processed</span>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                </td>
                                        ...
                                        <?php endwhile; else: ?>
                                        <tr>
                                            <td colspan="6" style="text-align:center; padding:2.5rem; color:#7b8eb0;">No
                                                applications yet.</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                    ...
                    <div id="hack-section" class="d-card">
                        ...
                        <div class="overflow-table">
                            <table class="data-table">
                                ...
                                <tbody>
                                    <?php if ($hackathons && $hackathons->num_rows > 0):
                                        while ($h = $hackathons->fetch_assoc()): ?>
                                            <tr>
                                                <td style="color:#e8f0ff; font-weight:600;"><?= htmlspecialchars($h['title']) ?>
                                                </td>
                                                <td><?= htmlspecialchars($h['location']) ?></td>
                                                <td
                                                    style="font-family:'JetBrains Mono',monospace; font-size:0.78rem; white-space:nowrap;">
                                                    <?= htmlspecialchars($h['date_start']) ?>
                                                </td>
                                                <td>
                                                    <span
                                                        class="badge badge-member"><?= htmlspecialchars($h['application_type']) ?></span>
                                                </td>
                                            </tr>
                                        <?php endwhile; else: ?>
                                        <tr>
                                            <td colspan="4" style="text-align:center; padding:2.5rem; color:#7b8eb0;">No
                                                hackathons found.</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function calcDuration() {
                if (!startInput.value || !endInput.value) { durDisplay.style.display = 'none'; return; }
                ...
                durDisplay.style.display = 'block';
                if (diffDays === 0) durVal.innerText = '24 Hours (Same Day)';
                else if (diffDays === 1) durVal.innerText = '2 Days (48 Hours)';
                else durVal.innerText = (diffDays + 1) + ' Days';
            }
