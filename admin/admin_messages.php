...
<aside class="sidebar">
    ...
    <a href="../admin/admin_dashboard.php" class="sidebar-link">
    ...
    <a href="../admin/admin_messages.php" class="sidebar-link active">
    ...
    <div class="sidebar-logout">
        <a href="../admin/admin_logout.php" class="sidebar-link" style="color:#ef4444; border:1px solid rgba(239,68,68,0.15); border-radius:6px;">
...
<main class="dash-main">
    ...
    <div class="d-card">
        ...
        <div class="filter-bar">
            <a href="../admin/admin_messages.php" class="filter-btn active" id="filter-all">All Messages</a>
            <a href="../admin/admin_messages.php?filter=unread" class="filter-btn <?= (($_GET['filter'] ?? '') === 'unread') ? 'active-danger' : '' ?>" id="filter-unread">🔔 Unread Only</a>
            <a href="../admin/admin_messages.php?filter=read" class="filter-btn <?= (($_GET['filter'] ?? '') === 'read') ? 'active' : '' ?>" id="filter-read">✅ Read Only</a>
        </div>
        ...
        <div class="messages-grid">
            ...
            <div class="msg-card <?= $is_unread ? 'unread' : '' ?>">
                ...
                <div class="msg-actions">
                    <?php if ($is_unread): ?>
                        <form method="POST" action="../admin/admin_messages.php" style="display:inline;">
