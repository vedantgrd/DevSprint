...
<section class="about-hero">
    ...
    <div style="display:flex;gap:1rem;margin-top:2.5rem;flex-wrap:wrap;justify-content:center;">
        <a href="../hackathons/hackathons.php" class="btn btn-primary"><span>Explore Missions</span><span class="btn-arrow">↗</span></a>
        <a href="../login/login_view.php" class="btn btn-ghost"><span>Join DevSprint</span></a>
    </div>
</section>
