...
<div class="contact-layout">
    ...
    <div class="contact-info-card reveal-left">
        ...
        <div style="display:flex;gap:0.75rem;flex-wrap:wrap;">
            <a href="../hackathons/hackathons.php" class="btn btn-primary btn-sm"><span>Browse Hackathons →</span></a>
            <a href="../about/about.php" class="btn btn-ghost btn-sm"><span>Our Mission</span></a>
        </div>
    </div>
    ...
    <div class="contact-form-card reveal-right">
        ...
        <?php if (!isset($_SESSION['user_id'])): ?>
            ...
            <div class="login-gate">
                ...
                <a href="../login/login_view.php?redirect=contact.php">⚡ LOGIN TO TRANSMIT</a>
            </div>
        ...
        ?>
            ...
            <form id="contactForm" action="../actions/send_message.php" method="POST">
...
<footer>
    <div class="footer-grid">
        ...
        <div class="footer-col"><h4>Account</h4><ul>
            ...
            <li><a href="../register/Registerpage_view.php">Register</a></li>
        </ul></div>
    </div>
