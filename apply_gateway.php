...
if (!isset($_SESSION['user_id'])) {
    echo "<script>alert('Please log in to apply.'); window.location.href='login_view.php';</script>";
    exit();
}
    ...
    <div class="apply-layout">
        ...
        <div class="apply-option reveal d2">
            ...
            <div style="display:flex;gap:0.75rem;margin-top:1rem;flex-wrap:wrap;">
                <a href="teams.php" class="btn btn-ghost btn-sm" style="flex:1;justify-content:center;"><span>Manage Teams</span></a>
                <a href="matchmaking.php" class="btn btn-ghost btn-sm" style="flex:1;justify-content:center;"><span>Find Teammates</span></a>
            </div>
        </div>
        <?php endif; ?>
